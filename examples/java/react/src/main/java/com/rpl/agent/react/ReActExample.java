 ...
 *
 * This example demonstrates how to create and run a ReAct (Reasoning and
 * Acting) agent that can search the web and answer questions using the
 * agent-o-rama framework.
 *
 * The agent uses:
 * - OpenAI GPT-4o-mini for language processing
 * - Tavily for web search capabilities
 * - ReAct pattern for alternating between reasoning and action
 *
