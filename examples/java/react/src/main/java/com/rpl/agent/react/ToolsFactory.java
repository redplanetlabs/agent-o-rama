 ...
 *
 * This class provides web search capabilities using the Tavily search engine,
 * allowing the agent to search for information on the web and incorporate
 * the results into its reasoning process.
 */
