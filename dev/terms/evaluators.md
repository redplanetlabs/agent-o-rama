...
## Architecture Role
Quality assessment layer for agent outputs. Enables systematic evaluation and performance tracking across multiple criteria.
...
## Key Clojure API
- Primary functions: Dataset evaluation functions
- Creation: User-defined functions
- Access: Via agent manager

## Key Java API
- Primary functions: `evaluate()`, `getScore()`
- Creation: Implement evaluator interface
