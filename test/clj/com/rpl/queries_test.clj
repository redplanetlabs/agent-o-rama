...
(deftest to-invokes-page-result-test
  (letlocals
   (is
    (=
     {:agent-invokes     [[1 2 19] [2 3 18] [2 2 14] [2 1 12] [1 1 11]]
      :pagination-params {0 nil 1 0 2 0}}
   ...
   (is
    (=
     {:agent-invokes     [[2 12 11] [2 11 10] [2 10 9] [2 0 8]]
      :pagination-params {0 300 1 3 2 nil}}
     (queries/to-invokes-page-result
      {0 {0   0
          100 1
          200 2
   ...
   (is
    (=
     {:agent-invokes     [[1 4 40] [0 0 37] [2 3 35] [3 3 32] [3 2 31] [1 2 30]
                          [2 2 25] [3 1 22] [1 1 20]]
      :pagination-params {0 nil 1 0 2 1 3 0}}
     (queries/to-invokes-page-result
      {0 {0 37}
       1 {0 10
          1 20
