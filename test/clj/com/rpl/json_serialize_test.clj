...
(deftest json-ser-test
  ...
  (is (jser= (Document/document "abcde" (Metadata. {"a" 1 "b" 2}))))
  ...
  (is (jser= (AiMessage/aiMessage "abc"
                                  [(-> (ToolExecutionRequest/builder)
                                   ...
                                   (-> (ToolExecutionRequest/builder)
                                       ...
                                       .build)])))
  (is (jser= (AiMessage/aiMessage "abc")))
  (is (jser= (CustomMessage. {"a" 1 "b" 10})))
  ...
  (is (jser= (TextSegment. "abcz" (Metadata. {"a" 1}))))
