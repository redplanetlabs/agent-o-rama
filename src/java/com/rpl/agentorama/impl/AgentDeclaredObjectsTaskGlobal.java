...
public class AgentDeclaredObjectsTaskGlobal implements TaskGlobalObject {
  ...
  public AgentDeclaredObjectsTaskGlobal(
      Map<String, Map<String, Object>> builders, Map<String, List<String>> agentsInfo) {
    _builders = builders;
          ...
          new WorkerManagedResource(
              ...
              () -> {
                if (threadSafe) return makeObject(name, afn, setup, autoTracing);
                  ...
                  return new LazyObjectPool(limit, () -> makeObject(name, afn, setup, autoTracing));
              }));
    }
        ...
        new WorkerManagedResource(
            ...
            () -> {
              ...
              for (String moduleName : moduleNames) {
                String mn =
                    moduleName == null
                        ? context.getModuleInstanceInfo().getModuleName()
                        : moduleName;
