...
public interface MultiAgg {
  ...
  public static <S, T0, T1, T2> MultiAgg.Impl on(
      String name, RamaFunction4<S, T0, T1, T2, Object> impl) {
    return create().on(name, impl);
  }

  public static <S, T0, T1, T2, T3> MultiAgg.Impl on(
      String name, RamaFunction5<S, T0, T1, T2, T3, Object> impl) {
    return create().on(name, impl);
  }

  public static <S, T0, T1, T2, T3, T4> MultiAgg.Impl on(
      String name, RamaFunction6<S, T0, T1, T2, T3, T4, Object> impl) {
    return create().on(name, impl);
  }

  public static <S, T0, T1, T2, T3, T4, T5> MultiAgg.Impl on(
      String name, RamaFunction7<S, T0, T1, T2, T3, T4, T5, Object> impl) {
    return create().on(name, impl);
  }

  public static <S, T0, T1, T2, T3, T4, T5, T6> MultiAgg.Impl on(
      String name, RamaFunction8<S, T0, T1, T2, T3, T4, T5, T6, Object> impl) {
    return create().on(name, impl);
  }
  ...
  interface Impl {
    ...
    <S, T0, T1, T2, T3> MultiAgg.Impl on(
        String name, RamaFunction5<S, T0, T1, T2, T3, Object> impl);

    <S, T0, T1, T2, T3, T4> MultiAgg.Impl on(
        String name, RamaFunction6<S, T0, T1, T2, T3, T4, Object> impl);

    <S, T0, T1, T2, T3, T4, T5> MultiAgg.Impl on(
        String name, RamaFunction7<S, T0, T1, T2, T3, T4, T5, Object> impl);

    <S, T0, T1, T2, T3, T4, T5, T6> MultiAgg.Impl on(
        String name, RamaFunction8<S, T0, T1, T2, T3, T4, T5, T6, Object> impl);
  }
}
